				...
				<nav id="nav">
					<ul>
						...
						<li class="break"><a href="right-sidebar.jsp">Right
								Sidebar</a></li>
						<li><a href="summerPallete.jsp">퍼스널 컬러 옷 색상 추천</a></li>
						<!--한줄띄우는 기능넣기 -->
					</ul>
				</nav>
			...
			<div class="item">
				<table style="border: 2px solid salmon;">
					<th style="background: linear-gradient(white, 15%, salmon);">
						<center>
							<h2
								style="margin-top: 0.5em; margin-bottom: 0.5em; color: white;">UR
								color가 추천하는 "여름 쿨톤" 색상 팔레트 입니다</h2>
						</center>
					</th>
					<tr>
						<td style="border-top: 2px solid salmon; font-weight: bolder;">
							<center style="positon: relative; bottom: 2px;">
								<img src="images/check.png" width="40px" ; height="40px">원하는
								색상을 클릭해서 나만의 색조합을 찾아보세요!
							</center>
						</td>
					</tr>
  ...
  <path id="product-shape5"
				...
				<div class=middle>
					...
					<div class="name"
						...
						<p
							style="font-weight: 500; font-size: 25px; color: white; margin-top: 25px;">여름
							쿨 상의 팔레트</p>
					</div>
					<div class="colors">
						<div class="color" data-hex="#ffd6e8" style="border: none"></div>
						<div class="color" data-hex="#f03d74" style="border: none"></div>
						<div class="color" data-hex="#fff9ab " style="border: none"></div>
						<div class="color" data-hex="#ccd5e6" style="border: none"></div>
						<div class="color" data-hex="#ccb4fe" style="border: none"></div>
						<div class="color" data-hex="#ace1cd" style="border: none"></div>
						<div class="color" data-hex="#2852ca" style="border: none"></div>
						<div class="color" data-hex="#674083" style="border: none"></div>
						<div class="color" data-hex="#dcbaac" style="border: none"></div>
						<div class="color" data-hex="#d8d3bd" style="border: none"></div>
					</div>
					<div class="name"
		...
		<center>
			<button onclick="location.href='no-sidebar.jsp'"
				style="background-color: salmon; color: white; height: 60px; width: 130px; margin-top: -10px; margin-bottom: 50px;">커뮤니티</button>
		</center>
