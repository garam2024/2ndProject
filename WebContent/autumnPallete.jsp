				...
				<nav id="nav">
					<ul>
						...
						<li class="break"><a href="right-sidebar.jsp">Right
								Sidebar</a></li>
						<li><a href="autumnPallete.jsp">퍼스널 컬러 옷 색상 추천</a></li>
						<!--한줄띄우는 기능넣기 -->
					</ul>
				</nav>
s
			...
			<div class="item">
				<table  style="border:2px solid salmon; ">
					<th style="background: linear-gradient(white, 15%, salmon);">
						<center><h2 style="margin-top:0.5em; margin-bottom:0.5em; color:white;">UR color가 추천하는 "가을 웜톤" 색상 팔레트 입니다</h2></center>
					</th>
					<tr>
  ...
  <path id="product-shape5"
				...
				<div class="name"
						...
						<p
							style="font-weight: 500; font-size: 25px; color: white; margin-top: 25px;">가을
							웜 상의 팔레트</p>
					</div>
					<div class="colors">
						<div class="color" data-hex="#fcf7e1" style="border:none"></div>
						<div class="color" data-hex="#ef9c70" style="border:none"></div>
						<div class="color" data-hex="#d40121" style="border:none"></div>
						<div class="color" data-hex="#e8c583" style="border:none"></div>
						<div class="color" data-hex="#ff9f2e" style="border:none"></div>
						<div class="color" data-hex="#6b3229" style="border:none"></div>
						<div class="color" data-hex="#a6bf61" style="border:none"></div>
						<div class="color" data-hex="#005385" style="border:none"></div>
						<div class="color" data-hex="#4a0e88" style="border:none"></div>
