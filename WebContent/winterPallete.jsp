...
.name {
	...
	background: linear-gradient(white, 15%, salmon);
	font-size: 20px;
...
<body class="no-sidebar is-preload" style="background-color:white;">
			...
			<div id="header" class="container">
				...
				<nav id="nav">
					<ul>
						...
						<li class="break"><a href="right-sidebar.jsp">Right
								Sidebar</a></li>
						<li><a href="winterPallete.jsp">퍼스널 컬러 옷 색상 추천</a></li>
						<!--한줄띄우는 기능넣기 -->
					</ul>
				</nav>
			...
			<div class="item">
				<table  style="border:2px solid salmon; ">
					<th style=" background: linear-gradient(white, 15%, salmon);">
						<center><h2 style="margin-top:0.5em; margin-bottom:0.5em; color:white;">UR color가 추천하는 "겨울 쿨톤" 색상 팔레트 입니다</h2></center>
					</th>
					<tr>
						<td style="border-top:2px solid salmon; font-weight:bolder;">
						<center><img src="images/check.png" width="40px"; height="40px" >원하는 색상을 클릭해서 나만의 색조합을 찾아보세요!</center>
						</td>
					</tr>
  ...
  <path id="product-shape5"
				...
				<div class=middle>
						...
						<p
							style="font-weight: 500; font-size: 25px; color: white; margin-top: 25px;">겨울
							쿨 상의 팔레트</p>
					</div>
					<div class="colors">
						<div class="color" data-hex="#fff9fd" style="border:none"></div>
						<div class="color" data-hex="#f7cfe9 " style="border:none"></div>
						<div class="color" data-hex="#fe32a3" style="border:none"></div>
						<div class="color" data-hex="#d8c7b3" style="border:none"></div>
						<div class="color" data-hex="#f2fe2e" style="border:none"></div>
						<div class="color" data-hex="#6f002d" style="border:none"></div>
						<div class="color" data-hex="#0035b9" style="border:none"></div>
						<div class="color" data-hex="#03005b" style="border:none"></div>
						<div class="color" data-hex="#02010f" style="border:none"></div>
						<div class="color" data-hex="#235239" style="border:none"></div>
					</div>
		<div class="name"
						style="text-align: center; background-color: salmon;">
						<p
							style="font-weight: 500; font-size: 25px; color: white; margin-top: 25p0 . . 252x;">
							겨울 쿨 하의 팔레트</p>
					</div>
					<div class="colors2">
		...
		<center><button onclick="location.href='no-sidebar.jsp'" style="background-color:salmon; color:white; height:60px; width:130px; margin-top:-10px; margin-bottom:50px;">커뮤니티</button></center>
