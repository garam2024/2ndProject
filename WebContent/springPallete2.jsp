...
<body class="no-sidebar is-preload" style="background-color: white;">
	<div id="page-wrapper">
				...
				<nav id="nav">
					<ul>
						...
						<li class="break"><a href="right-sidebar.jsp">Right
								Sidebar</a></li>
						<li><a href="springPallete.jsp">퍼스널 컬러 옷 색상 추천</a></li>
						<!--한줄띄우는 기능넣기 -->
					</ul>
				</nav>
		...
		<div class="container" id="main">
					...
					<th style="background: linear-gradient(white, 15%, salmon);">
						<center>
							<h2
								...
								color가 추천하는 "봄 웜톤" 색상 팔레트 입니다</h2>
						</center>
					</th>
					<tr>
						<td style="border-top: 2px solid salmon; font-weight: bolder;">
							<center>
								<img src="images/check.png" width="40px" ; height="40px style="padding-top:10px;" >원하는
			...
			<div class="item" style="margin-bottom: 150px;">
				<div class=middle>
  ...
  <path id="product-shape5"
				...
				<div class=middle>
					...
					<div class="name"
						style="text-align: center; background: linear-gradient(white, 15%, salmon);">
						<p
					...
					<button onclick="advertise()"
						style="background-color: salmon; color: white; height: 60px; width: 130px; position: relative; top: 10px; margin-top: -10px; margin-bottom: 0; float: right">컬러
						고르기</button>
				</div>

			</div style="margin-bottom: 200px;" >
			<div width="100%"
				style="border: 2px solid salmon; width: 1198px; height: 85.31px; background: linear-gradient(white, 15%, salmon); color: white; text-align: center; font-weight: 600; font-size: 2em; padding-top: 25px;">봄
				웜 코디 TIP</div>

			<img src="images/chcun1.png" width=100%; style="margin-top: 70px;">

			<img src="images/springchcun.png" width=100%;
				style="margin-right: 500px"> <img src="images/ad.png"
				width=100%; style="margin-top: 100px; margin-right: 500px;">
